import adivinaLaPalabra from './assets/image.png'
import yuhjakLogo from './assets/Logo-yuhjak-round.svg'
import yuhjakNewLogo from './assets/Logo-yuhjak-nuevo.jpg'
...
const App = () => {
  return (
    <>
      <section className="mx-auto max-w-[696px] p-6 pb-12 z-10">
        <div className="flex items-center pb-4 pt-10">
          <h1 className="text-3xl text-orange-500 font-bold pr-2">Unai</h1>
          <span className="text-1xl font-semibold text-zinc-700 hover:text-white transition-colors duration-300 ease-in-out">
            ～ @yuhjak25
          </span>
        </div>
        <article>
          <h1 className="text-white text-5xl font-extrabold">
            Estudiante de Desarrollador de Aplicaciones Web
          </h1>
          <p className="text-gray-200 pt-4">
            Apasionado por aprender y crear aplicaciones web innovadoras.
            Enfocado en mejorar continuamente mis habilidades y construir
            soluciones digitales impactantes. De Madrid, España 🇪🇸.
          </p>
        </article>
        <section>
            ...
            <article className="h-auto w-auto border-2 border-zinc-700 rounded-lg p-4">
              <div>
                ...
                <p className="text-gray-200 pb-2">
                  Un pequeño proyecto creado para practicar Redux Toolkit junto
                  a React y TypeScript.
                </p>
